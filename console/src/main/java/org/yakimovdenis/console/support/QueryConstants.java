...
public class QueryConstants {
    ...
    public final static String SAVE_FILE_STATISTIC = "INSERT INTO files (filename, created, longest_word, shortest_word, average_word_length, size) values (:file_name, :longest_word, :shortest_word, :average_word_length, :size, :upload_date)";
